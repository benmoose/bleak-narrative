...
import HostedVideo from '../video'
import Video from './video'

const SLICE_TYPES = ['one_photo', 'two_photos', 'three_photos', 'photo___text', 'full_width_image', 'external_video', 'hosted_video']
      ...
      />
      {
        document.data.body.map((slice, i) => {
          switch (slice.slice_type) {
            ...
            case 'hosted_video':
              return <HostedVideo items={slice.items} />
            default:
